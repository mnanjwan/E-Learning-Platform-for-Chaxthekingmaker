...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('website_asset/css/line-awesome.css') }}">
    <link rel="stylesheet" href="{{ asset('website_asset/css/owl.carousel.min.css') }}">
    <link rel="stylesheet" href="{{ asset('website_asset/css/owl.theme.default.min.css') }}">
    <link rel="stylesheet" href="{{ asset('website_asset/css/bootstrap-select.min.css') }}">
    <link rel="stylesheet" href="{{ asset('website_asset/css/fancybox.css') }}">
    <link rel="stylesheet" href="{{ asset('website_asset/css/animated-headline.css') }}">
    <link rel="stylesheet" href="{{ asset('website_asset/css/plyr.css') }}">
    <link rel="stylesheet" href="{{ asset('website_asset/css/jquery-te-1.4.0.css') }}">
...
<body>
    ...
    <!-- template js files -->
    <script src="{{ asset('website_asset/js/jquery-3.4.1.min.js') }} "></script>
    <script src="{{ asset('website_asset/js/bootstrap.bundle.min.js') }}"></script>
    <script src="{{ asset('website_asset/js/bootstrap-select.min.j') }}s"></script>
    <script src="{{ asset('website_asset/js/owl.carousel.min.js') }}"></script>
    <script src="{{ asset('website_asset/js/isotope.js') }}"></script>
    <script src="{{ asset('website_asset/js/waypoint.min.js') }}"></script>
    <script src="{{ asset('website_asset/js/jquery.counterup.min.js') }}"></script>
    <script src="{{ asset('website_asset/js/fancybox.js') }}"></script>
    <script src="{{ asset('website_asset/js/plyr.js') }}"></script>
    <script src="{{ asset('website_asset/js/datedropper.min.js') }}"></script>
    <script src="{{ asset('website_asset/js/emojionearea.min.js') }}"></script>
    <script src="{{ asset('website_asset/js/jquery-te-1.4.0.min.js') }}"></script>
    <script src="{{ asset('website_asset/js/jquery.MultiFile.min.js') }}"></script>
