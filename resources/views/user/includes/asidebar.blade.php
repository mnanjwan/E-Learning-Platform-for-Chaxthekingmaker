<div class="off-canvas-menu dashboard-off-canvas-menu off--canvas-menu custom-scrollbar-styled pt-20px">
    ...
    <div class="logo-box px-4">
        <a href="{{ route('dashboard') }}" class="logo"><img src="{{ asset('user_asset/images/logo.png') }}"
                alt="logo" width="100%" /></a>
    </div>
    <ul class="generic-list-item off-canvas-menu-list off--canvas-menu-list pt-35px">
        <li class=" {{ request()->is('user/dashboard') ? ' page-active' : '' }}">
        ...
        {{-- <li>
            <a href="dashboard-reviews.html"><svg class="mr-2" xmlns="http://www.w3.org/2000/svg"
        ...
        <hr>
        <li class="{{ request()->is('user/referrals') ? ' page-active' : '' }}">
            <a href="{{ route('user.referral') }}"><svg class="mr-2" xmlns="http://www.w3.org/2000/svg" height="18px"
                    viewBox="0 0 24 24" width="18px">
                    <path d="M0 0h24v24H0V0z" fill="none" />
                    <path
        ...
        <li class="{{ request()->is('user/transaction/history') ? ' page-active' : '' }}">
            <a href="{{ route('transaction.history') }}"><svg class="mr-2" xmlns="http://www.w3.org/2000/svg"
                    height="18px" viewBox="0 0 24 24" width="18px">
                    <path d="M0 0h24v24H0V0z" fill="none" />
                    <path
        ...
        <hr>
        <li class="{{ request()->is('user/profile') ? ' page-active' : '' }}">
        ...
        <li>
            <a href="{{route('settings')}}"><svg class="mr-2" xmlns="http://www.w3.org/2000/svg" height="18px" viewBox="0 0 24 24"
                    width="18px">
                    <path d="M0 0h24v24H0V0z" fill="none" />
                    <path
