                    ...
                    <div class="setting-body">
                        ...
                        <div class="media media-card align-items-center">
                            <div class="media-img media-img-lg mr-4 bg-gray">
                                <img class="mr-3" src="{{asset('user_asset/images/avatar.jpg') ?? ''}}" alt="avatar image">
                            </div>
                        ...
                        <form method="post" class="row pt-40px">
                            <div class="input-box col-lg-3">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control" type="text" name="text" @disabled(true) value="">
                            ...
                            <div class="input-box col-lg-3">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control" type="email" name="email" @disabled(true) value="">
