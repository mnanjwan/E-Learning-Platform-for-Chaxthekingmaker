                ...
                <div class="tab-pane fade show active" id="earning" role="tabpanel" aria-labelledby="earning-tab">
                    <div class="row">
                        <div class="col-lg-6 responsive-column-half">
                            <div class="card6card-item dashboard-info-card">
                                <div class="card-body d-flex align-items-center">
                                    ...
                                    <div class="pl-4">
                                        <p class="card-text fs-18">My Earnings</p>
                        ...
                        <div class="col-lg-4 responsive-column-half">
                            <div class="card6card-item dashboard-info-card">
                                <div class="card-body d-flex align-items-center">
                                    ...
                                    <div class="pl-4">
                                        <p class="card-text fs-18">Payouts</p>
                                        <h5 class="card-title pt-2 fs-26">${{number_format($totalWithdrawal)}}</h5>
                                    </div>
                                </div><!-- end card-body -->
                            </div><!-- end card -->
                        </div><!-- end col-lg-4 -->
